...
class Main_M extends CI_Model {
    ...
    public function getUserLog(){
        $query = $this->db->get('tbl_user_logs');
        return $query->result();
    }

    public function reportPrint(){
        $query =$this->db->query("select count(tbl_user.email) as count, tbl_region.regionName from tbl_user,tbl_user_logs,tbl_region where tbl_user.email = tbl_user_logs.email and tbl_user.regionPSGC = tbl_region.regionPSGC group by tbl_user.regionPSGC;");
        return $query->result();
    }
}
