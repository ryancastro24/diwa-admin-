...
class Main_C extends CI_Controller {
	...
	public function userlog(){
		$hdata['page'] = 'usl';
		$data['userLogDetails'] = $this->main_m->getUserLog();
		$this->load->view('header',$hdata);
	...
	public function reportPrint(){
		$hdata['page'] = 'reP';
		$data['reportDetails'] = $this->main_m->reportPrint();
		$data['userLogDetails'] = $this->main_m->getUserLog();
		$this->load->view('reportPrintHeader', $hdata);
		$this->load->view('reportPrint',$data);
		$this->load->view('reportPrintFooter');
	}
